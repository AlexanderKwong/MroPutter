...
//				m[i][4] = size ;
	...
	class PopupListener extends MouseAdapter {
		...
		public void mousePressed(final MouseEvent e) {
			System.out.println("PopupListener mousePressed eventType is " + e.getID());
			maybeShowPopup(e);
		}

		@Override
		public void mouseReleased(final MouseEvent e) {
			System.out.println("PopupListener mouseReleased eventType is " + e.getID());
			maybeShowPopup(e);
		}

		private void maybeShowPopup(final MouseEvent e) {
			if (e.isPopupTrigger()) {
			System.out.println("PopupListener maybeShowPopup isTrigger " + e.isPopupTrigger());
	...
	class PopupTextListener extends MouseAdapter {
		@Override
		public void mousePressed(final MouseEvent e) {
			System.out.println("PopupTextListener mousePressed eventType is " + e.getID());
			maybeShowPopup(e);
		}

		@Override
		public void mouseReleased(final MouseEvent e) {
			System.out.println("PopupTextListener mouseReleased eventType is " + e.getID());
			maybeShowPopup(e);
		}

		private void maybeShowPopup(final MouseEvent e) {
			if (e.isPopupTrigger()) {
			System.out.println("PopupTextListener maybeShowPopup eventType isTrigger " + e.isPopupTrigger());
