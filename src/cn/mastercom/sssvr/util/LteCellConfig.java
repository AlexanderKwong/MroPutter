...
public class LteCellConfig
{
	...
	{
		lteCellPath = ReturnConfig.returnconfig("conf/config_figureFix.xml", "//comm//gongcan");
	...
	private Map<Long, List<LteCellInfo>> fcnPciLteCellMap;
