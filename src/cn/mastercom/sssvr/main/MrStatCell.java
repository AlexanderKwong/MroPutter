...
public class MrStatCell implements IResultTable
{
	...
	public MrStatCell(Sample_4G sample, int statTime)
	{
	...
	{
		// 此处按天计算,所以没有添加时间因素
		return sample.cityID + "_" + sample.Eci;
	}

	public void Stat(Sample_4G sample)
	{
	...
	public String toLine()
	{
		...
		sb.append(iMRCnt);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor);
		sb.append(tabMark);
		sb.append(iMRRSRQCnt);
		sb.append(tabMark);
		sb.append(iMRRSRQCnt_Indoor);
		sb.append(tabMark);
		sb.append(iMRRSRQCnt_Outdoor);
		sb.append(tabMark);
		sb.append(iMRSINRCnt);
		sb.append(tabMark);
		sb.append(iMRSINRCnt_Indoor);
		sb.append(tabMark);
		sb.append(iMRSINRCnt_Outdoor);
		sb.append(tabMark);
		...
		sb.append(tabMark);
		sb.append(iMRCnt_In_URI);
		sb.append(tabMark);
		sb.append(iMRCnt_In_SDK);
		sb.append(tabMark);
		sb.append(iMRCnt_In_WLAN);
		sb.append(tabMark);
		sb.append(iMRCnt_In_SIMU);
		sb.append(tabMark);
		sb.append(iMRCnt_In_Other);
		sb.append(tabMark);
		sb.append(fRSRPValue);
		sb.append(tabMark);
		sb.append(fRSRPValue_Indoor);
		sb.append(tabMark);
		sb.append(fRSRPValue_Outdoor);
		sb.append(tabMark);
		sb.append(fRSRQValue);
		sb.append(tabMark);
		sb.append(fRSRQValue_Indoor);
		sb.append(tabMark);
		sb.append(fRSRQValue_Outdoor);
		sb.append(tabMark);
		sb.append(fSINRValue);
		sb.append(tabMark);
		sb.append(fSINRValue_Indoor);
		sb.append(tabMark);
		sb.append(fSINRValue_Outdoor);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_0_70);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_70_80);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_80_90);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_90_95);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_100);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_103);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_105);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_110);
		sb.append(tabMark);
		sb.append(iMRCnt_Indoor_113);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_0_70);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_70_80);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_80_90);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_90_95);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_100);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_103);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_105);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_110);
		sb.append(tabMark);
		sb.append(iMRCnt_Outdoor_113);
		sb.append(tabMark);
		sb.append(iIndoorRSRP100_SINR0);
		sb.append(tabMark);
		sb.append(iIndoorRSRP105_SINR0);
		sb.append(tabMark);
		sb.append(iIndoorRSRP110_SINR3);
		sb.append(tabMark);
		sb.append(iIndoorRSRP110_SINR0);
		sb.append(tabMark);
		sb.append(iOutdoorRSRP100_SINR0);
		sb.append(tabMark);
		sb.append(iOutdoorRSRP105_SINR0);
		sb.append(tabMark);
		sb.append(iOutdoorRSRP110_SINR3);
		sb.append(tabMark);
		sb.append(iOutdoorRSRP110_SINR0);
		sb.append(tabMark);
		sb.append(iSINR_Indoor_0);
		sb.append(tabMark);
		sb.append(iRSRQ_Indoor_14);
		sb.append(tabMark);
		sb.append(iSINR_Outdoor_0);
		sb.append(tabMark);
		sb.append(iRSRQ_Outdoor_14);
