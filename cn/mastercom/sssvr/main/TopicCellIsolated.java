...
public class TopicCellIsolated implements IResultTable
{
	...
	public TopicCellIsolated(Sample_4G sample, int statTime)
	{
	...
	public String toLine()
	{
		...
		sb.append(iMRCnt);
		sb.append(tabMark);
		sb.append(iMRCnt_NoNei);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_95);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_100);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_103);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_105);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_110);
		sb.append(tabMark);
		sb.append(iMRCnt_Nei_113);
